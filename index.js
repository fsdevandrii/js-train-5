...
function multiplyArray(array) {
  ...
  let product = 1; // Ініціалізуємо змінну для зберігання добутку

  for (let value of array) {
    product *= value; // Множимо кожен елемент на загальний добуток
  }
...
// Завдання 4: Дано масив рядків. Видаліть третій елемент масиву та перетворіть в рядок за допомогою
// методу toString().Результат виведіть на консоль.
function modifyArray(array) {
  ...
  const resultString = array.toString(); // Перетворюємо масив в рядок за допомогою методу toString()
  console.log(resultString); // Виводимо результат на консоль
}
...
function printUppercase(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    let uppercaseElement = array[i].toUpperCase(); // Перетворюємо елемент в верхній регістр
    console.log(uppercaseElement); // Виводимо на консоль
  }
}
...
function findMinMax([firstElement, ...restElements]) {
  ...
  let min = firstElement; // Ініціалізуємо мінімальне значення першим елементом масиву
  let max = firstElement; // Ініціалізуємо максимальне значення першим елементом масиву

  for (let element of restElements) {
    if (element < min) {
      min = element; // Оновлюємо мінімальне значення
    }
    if (element > max) {
      max = element; // Оновлюємо максимальне значення
    }
  }

  console.log(`Min: ${min} Max: ${max}`); // Виводимо мінімальне та максимальне значення на консоль
}
...
function printStrings(array) {
  ...
  const stringRepresent = array.toString(); // Перетворюємо масив в рядок за допомогою методу toString()
  const repeatedString = stringRepresent + stringRepresent; // Повторюємо рядок двічі

  console.log(repeatedString); // Виводимо результат на консоль
}
...
function concatenateStrings(array, subString) {
  ...
  const stringRepresent = array.toString(); // Перетворюємо масив в рядок за допомогою методу toString()
  const includesSubstring = stringRepresent.includes(subString); // Перевіряємо чи містить рядок підрядок

  console.log(includesSubstring); // Виводимо результат на консоль
}
...
function addTenToEach(array) {
  ...
  const resultArray = []; // Ініціалізуємо новий масив для зберігання результату

  for (let index in array) {
    resultArray.push(array[index] + 10); // Додаємо до поточного елемента 10 і додаємо результат в новий масив
  }

  console.log(resultArray); // Виводимо результат на консоль
}
...
function swapMinMax(array) {
  ...
  let max = array[0]; // Ініціалізуємо max першим елементом масиву
  let min = array[0]; // Ініціалізуємо min першим елементом масиву
  let maxIndex = 0; // Ініціалізуємо maxIndex нульовим значенням
  let minIndex = 0; // Ініціалізуємо minIndex нульовим значенням
  ...
  [array[maxIndex], array[minIndex]] = [array[minIndex], array[maxIndex]]; // Обмінюємо місцями мінімальне та максимальне значення
...
function getEvenNumbers(arr) {
  ...
  const result = []; // Створюємо пустий масив для зберігання результату

  for (let i = 0; i < arr.length; i++) {
    if (arr[i] % 2 === 0) {
      result.push(arr[i]); // Перевіряємо чи є число парним і додаємо його до масиву результату
    }
  }

  return result; // Повертаємо масив результату
}
